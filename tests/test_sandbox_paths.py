...
def test_resolve_repo_dir_uses_provider_work_dir() -> None:
    ...
    repo_dir = resolve_repo_dir(backend, "native-swe")

    assert repo_dir == "/workspace/native-swe"
...
async def test_aresolve_repo_dir_offloads_sync_resolution() -> None:
    ...
    repo_dir = await aresolve_repo_dir(backend, "native-swe")

    assert repo_dir == "/home/daytona/native-swe"
