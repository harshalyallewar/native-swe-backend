...
def test_build_github_issue_prompt_includes_issue_context() -> None:
    prompt = webapp.build_github_issue_prompt(
        {"owner": "langchain-ai", "name": "native-swe"},
        42,
        "12345",
        "Fix the flaky test",
    ...
    response = _post_github_webhook(
        ...
        "issues",
        {
            ...
            "issue": {
                "id": 12345,
                "number": 42,
                "title": "@nativeswe fix the flaky test",
                "body": "The test is failing intermittently.",
            },
            "repository": {"owner": {"login": "langchain-ai"}, "name": "native-swe"},
...
def test_github_webhook_accepts_issue_comment_events(monkeypatch) -> None:
    ...
    response = _post_github_webhook(
        ...
        "issue_comment",
        {
            ...
            "comment": {"body": "@nativeswe please handle this"},
            "repository": {"owner": {"login": "langchain-ai"}, "name": "native-swe"},
            "sender": {"login": "octocat"},
        },
    )
        ...
        webapp.process_github_issue(
            {
                "issue": {
                    ...
                    "body": "The test is failing intermittently.",
                    "html_url": "https://github.com/langchain-ai/native-swe/issues/42",
                },
                "comment": {"id": 999, "body": "@nativeswe please handle this"},
                "repository": {"owner": {"login": "langchain-ai"}, "name": "native-swe"},
                "sender": {"login": "octocat"},
            },
            "issue_comment",
        ...
        webapp.process_github_issue(
            {
                ...
                "comment": {
                    "id": 999,
                    "body": "@nativeswe please handle this",
                    "user": {"login": "octocat"},
                },
                "repository": {"owner": {"login": "langchain-ai"}, "name": "native-swe"},
                "sender": {"login": "octocat"},
