...
WORKFLOW_SCOPE_OUTPUT = (
    ...
    " ! [remote rejected]       native-swe/abc -> native-swe/abc "
...
WORKFLOW_PERMISSION_OUTPUT = (
    "To https://github.com/langchain-ai/native-swe.git\n"
    " ! [remote rejected]       native-swe/abc -> native-swe/abc "
    "(refusing to allow a GitHub App to create or update workflow "
    "`.github/workflows/ci.yml` without `workflows` permission)\n"
    "error: failed to push some refs to 'https://github.com/langchain-ai/native-swe.git'\n"
)
...
def _run_with_push_result(push_result: MagicMock) -> dict:
    ...
    config = {
        "configurable": {
            ...
            "repo": {"owner": "langchain-ai", "name": "native-swe"},
        },
        "metadata": {},
    }
    sandbox = MagicMock()
    ...
    patches = [
        ...
        patch(
            ...
            return_value="native-swe/test-thread-id",
        ),
...
class TestWorkflowScopePushError:
    ...
    def test_non_workflow_push_error_returns_generic_message(self):
        ...
        generic_output = (
            "To https://github.com/langchain-ai/native-swe.git\n"
            " ! [rejected] native-swe/abc -> native-swe/abc (non-fast-forward)\n"
