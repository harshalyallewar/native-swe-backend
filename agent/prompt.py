...
5. **Comment** — Call `slack_thread_reply` or `github_comment` with a summary and the PR link.
...
2. **Comment** — Call `slack_thread_reply` or `github_comment` with your answer. Never leave a question unanswered."""
