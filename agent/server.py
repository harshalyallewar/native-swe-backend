"""Main entry point and CLI loop for Native-SWE agent."""
# ruff: noqa: E402
...
DEFAULT_LLM_MODEL_ID = "nvidia:meta/llama-3.1-70b-instruct"
...
async def get_agent(config: RunnableConfig) -> Pregel:
    ...
    if sandbox_id != sandbox_backend.id:
        ...
        await asyncio.to_thread(
            ...
            "git config --global user.name 'native-swe[bot]' && git config --global user.email 'native-swe@users.noreply.github.com'",
        )
