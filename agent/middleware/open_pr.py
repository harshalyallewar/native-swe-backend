...
async def open_pr_if_needed(
    ...
    try:
        ...
        pr_title = pr_payload.get("title", "feat: Native-SWE PR")
        pr_body = pr_payload.get("body", "Automated PR created by Native-SWE agent.")
        ...
        target_branch = branch_name if branch_name else f"native-swe/{thread_id}"
